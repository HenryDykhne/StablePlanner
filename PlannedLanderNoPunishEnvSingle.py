...
class PlannedLunarLanderNoPunishSingle(gym.Env, EzPickle):
    """
    ### Description
    ...
    def __init__(
        ...
        self.observation_space = spaces.Dict({'oldActions': spaces.MultiDiscrete([4]), 'normalObs': spaces.Box(low, high)})
