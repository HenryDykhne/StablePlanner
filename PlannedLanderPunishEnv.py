...
class PlannedLunarLanderPunish(gym.Env, EzPickle):
    """
    ### Description
    ...
    def __init__(
        ...
        self.observation_space = spaces.Dict({'oldActions': spaces.MultiDiscrete([4,4,4]), 'normalObs': spaces.Box(low, high)})
    ...
    def reset(self, seed: Optional[int] = None):
        ...
        if self.render_mode == "human":
            self.render()
        return self.step(np.array([0, 0]) if self.continuous else [0, 0, 0])[0]# , {}
