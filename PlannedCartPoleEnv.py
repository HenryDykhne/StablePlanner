...
class PlannedCartPole(gym.Env):
    ...
    def __init__(self, steps: int = 3, punish: bool = False):
        ...
        self.action_space = spaces.MultiDiscrete([4] * self.steps)
        self.observation_space = spaces.Dict({'oldActions': spaces.MultiDiscrete([4] * self.steps), 'normalObs': spaces.Box(-high, high, dtype=np.float32)})
    ...
    def step(self, action):
        ...
        return {'oldActions': actionList, 'normalObs': np.array(self.state, dtype=np.float32)}, reward, done, {}
