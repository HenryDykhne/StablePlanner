...
class PlannedCarRacing(gym.Env, EzPickle):
    """
    ### Description
    ...
    def __init__(
        ...
        self.observation_space = spaces.Dict({'oldActions': spaces.MultiDiscrete([5] * self.steps), spaces.Box(low=0, high=255, shape=(STATE_H, STATE_W, 3), dtype=np.uint8)})
